"""
Django settings for doorguard project.
...
MIDDLEWARE_CLASSES = (
    ...
    'doorguard.middleware.MobileClientLoginMiddleware',
)

ROOT_URLCONF = 'doorguard.urls'
...
WSGI_APPLICATION = 'doorguard.wsgi.application'
